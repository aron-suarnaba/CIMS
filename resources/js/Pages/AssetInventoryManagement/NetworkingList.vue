...
const submitAddForm = () => {
    addForm.post(route('networking.store'), {
        forceFormData: true,
        onSuccess: () => {
            addForm.reset();
            if (samplePicObjectUrl) {
...
const updateSubmit = () => {
    updateForm.put(route('networking.update', updateForm.id), {
        preserveScroll: true,
        forceFormData: true,
        onSuccess: () => {
            updateForm.image = null;
...
onMounted(() => {
    document
        .getElementById('AddNetworkingModal')
...
<template>
                    ...
                    <div class="row align-items-center g-3">
                        ...
                        <div class="col-md-4 d-flex justify-content-md-end gap-2">
                            <button class="btn btn-primary shadow-sm" data-bs-toggle="modal"
                                data-bs-target="#AddNetworkingModal">
                                <i class="bi bi-plus-lg me-1"></i> Add Networking Asset
                            </button>
                            ...
                            <tbody>
                                <tr v-for="(phone, i) in props.phones.data" :key="phone.id" @click="
                                    ...
                                    <td class="d-flex justify-content-center align-items-center gap-2">
                                        <button type="button" class="btn btn-outline-warning" data-bs-toggle="modal"
                                            data-bs-target="#UpdateNetworkingModal" @click.stop="openUpdateModal(phone)">
                                ...
                                <tr v-if="props.phones.data.length === 0">
                                    <td colspan="7" class="text-muted py-5 text-center">
                                        No networking assets found matching your criteria.
                                    </td>
                                </tr>
                            </tbody>
                        </table>
    ...
    <!-- Update Modals -->
    <Modals id="UpdateNetworkingModal" title="Update Networking Asset" header-class="bg-primary text-white bg-gradient" layout="bento">
        <template #body>
    ...
    <Modals id="AddNetworkingModal" title="Add New Networking Asset" header-icon="bi bi-plus-lg me-1 fs-4"
            ...
            <form @submit.prevent="submitAddForm" id="addPhoneForm">
                ...
                <div class="row d-flex align-items-center mb-3">
                    ...
                    <div class="col-sm-12 col-md-6">
                        ...
                        <input type="text" id="modelInput" v-model="addForm.model" placeholder="(e.g. Cisco SG350)"
