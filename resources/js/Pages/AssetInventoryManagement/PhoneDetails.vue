                    ...
                    <div class="card bg-light mb-4 border-0 shadow-sm">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            ...
                            <div class="btn-group shadow-sm">
                                ...
                                " class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#IssuePhoneModal">
                                    <i class="bi bi-person-plus me-1"></i> Issue
                                    Asset
                                </button>
                                <button v-else-if="props.phone.status === 'issued'" class="btn btn-warning"
                                    data-bs-toggle="modal" data-bs-target="#ReturnPhoneModal">
        ...
        <template #body>
            <form @submit.prevent="submit" id="issueForm">
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex justify-content-around gap-2 rounded border p-2">
                        <div class="form-check">
                ...
                <div class="mb-3">
                    <label class="form-label d-block text-muted small fw-bold"><i class="text-danger me-1">*</i>Cashout
                        Status</label>

                    <div class="d-flex justify-content-center align-items-center gap-2 rounded border py-2">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" id="without_cashout" value="0"
                                v-model="form.cashout">
                ...
                <div class="mb-3">
                    ...
                    <textarea v-model="form.remarks" id="issueRemarks" rows="3" class="form-control"></textarea>
                </div>
            </form>
        </template>
